...
@section('content')
    ...
    <div class="container d-flex flex-column py-3">
        <h2 class="text-center">แก้ไขข้อมูล <i class="fa-solid fa-house"></i></h2>
        <div class="card shadow-sm rounded-3 my-auto col-md-11 mx-auto bg-white">

            <div class="card-header">
                <h5>แก้ไขข้อมูลของคุณ</h5>
            </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('update', $edit->id) }}" method="post" class="row">
                    @csrf
                    ...
                    <div class="form-group col-lg-10">
                        ...
                        <input type="text" class="form-control" id="name_our" name="name_our"
                            value="{{ $edit->name_our }}" placeholder="กรุณากรอกชื่อ-นามสกุล">
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" class="form-control" id="id_number_our" name="id_number_our"
                            value="{{ $edit->id_number_our }}" placeholder="กรุณากรอกรหัสประจำตัว">
                    </div>
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" class="form-control" id="phone_number_our" name="phone_number_our"
                            value="{{ $edit->phone_number_our }}" placeholder="กรุณากรอกเบอร์โทรศัพท์">
                        ...
                        <select
                            ...
                            @foreach ($provinces as $item)
                                <option value="{{ $item->id }}"
                                    {{ $edit->provinces_our == $item->id ? 'selected' : '' }}>
                                    {{ $item->name_th }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select
                            ...
                            @foreach ($amphures as $amphure)
                                <option value="{{ $amphure->id }}"
                                    {{ $edit->amphures_our == $amphure->id ? 'selected' : '' }}>
                                    {{ $amphure->name_th }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select
                            ...
                            @foreach ($districts as $district)
                                <option value="{{ $district->id }}"
                                    {{ $edit->districts_our == $district->id ? 'selected' : '' }}>
                                    {{ $district->name_th }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="rel_our" name="rel_our"
                            value="{{ $edit->rel_our }}" placeholder="กรุณากรอกความสัมพันธ์">
                    </div>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <select
                            ...
                            @foreach ($provinces as $item)
                                <option value="{{ $item->id }}"
                                    {{ $edit->provinces_his == $item->id ? 'selected' : '' }}>
                                    {{ $item->name_th }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <select
                            ...
                            @foreach ($amphures as $amphure)
                                <option value="{{ $amphure->id }}"
                                    {{ $edit->amphures_his == $amphure->id ? 'selected' : '' }}>
                                    {{ $amphure->name_th }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <select
                            ...
                            @foreach ($districts as $district)
                                <option value="{{ $district->id }}"
                                    {{ $edit->districts_his == $district->id ? 'selected' : '' }}>
                                    {{ $district->name_th }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-lg-3">
                        ...
                        <input type="text" class="form-control" id="gap_his" name="gap_his"
                            value="{{ $edit->gap_his }}" placeholder="กรุณากรอกหมายเลขรับรอง GAP">
                    </div>

                    <div class="form-group col-lg-2">
                        <label for="date_his" class="form-label">วันที่คาดว่าจะเก็บเกี่ยว</label>
                        <input type="text" name="date_his" value="{{ $edit->date_his }}"
                    ...
                    <div class="form-group col-lg-3">
                        <label for="quantity_his" class="form-label">ปริมาณผลผลิตที่คาดว่าจะเก็บเกี่ยว
                            (กิโลกรัม)</label>
                        <input type="text" name="quantity_his" id="quantity_his" value="{{ $edit->quantity_his }}"
